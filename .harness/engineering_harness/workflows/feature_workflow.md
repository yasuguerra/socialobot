...
User sends request
        ↓
[CPO] Analyzes concept & drafts brief (Product Harness)
        ↓
...
⚠️ This workflow assumes a Product Brief already exists. If no brief exists, activate the Product Harness first.
Load: [.harness/product_harness/README.md](.harness/product_harness/README.md)

```
1. CTO receives user request (via CPO with an approved Product Brief)
