...
| Phase | File to load |
|------|-----------------|
| User Request / Strategy | `.harness/product_harness/CPO.md` |
...
| Marketing & SEO Growth | `roles/cmo.md` |
...
```
.harness/
├── product_harness/           ← Product decision system (WHAT & FOR WHOM)
│   ├── README.md              ← Index of product harness
│   ├── CPO.md
│   ├── PM.md
│   ├── UIUX.md
│   └── PRODUCT_QA.md
│
└── engineering_harness/       ← Engineering execution system (HOW & QUALITY)
