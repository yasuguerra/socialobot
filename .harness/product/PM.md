...
- Coordinates the formal handoff to Engineering (see [definition_of_ready.md](.harness/product/definition_of_ready.md))
...
**Date:** [YYYY-MM-DD]
**Owner:** [PM / CPO]
**ICE Score:** [see ice_scoring.md](.harness/product/ice_scoring.md)
