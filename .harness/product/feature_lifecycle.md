...
**Activities:**
- CPO evaluates the idea using the 6 questions of the role (see [CPO.md](.harness/product/CPO.md))
- Preliminary ICE Score is calculated (see [ice_scoring.md](.harness/product/ice_scoring.md))
...
**Activities:**
- PM drafts the complete PRD (see [PRD_template.md](.harness/product/PRD_template.md))
...
**Output:** Flow specification (see [UIUX.md](.harness/product/UIUX.md) — Standard output).
...
- Uses the standard checklist (see [usability_audit.md](.harness/product/usability_audit.md))
...
**Activities:**
- PM completes the Product Brief (see [product_brief_template.md](.harness/product/product_brief_template.md))
